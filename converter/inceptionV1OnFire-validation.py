...
# Example : perform validation of InceptionV1-OnFire models in TFLearn, PB and TFLite formats
...
model_tflearn.load(os.path.join("../models/InceptionV1-OnFire", "inceptiononv1onfire"),weights_only=True)
print("OK")
...
tensorflow_pb_model = cv2.dnn.readNetFromTensorflow('inceptionv1onfire.pb')
print("OK")
...
tflife_model = tf.lite.Interpreter(model_path="inceptionv1onfire.tflite")
